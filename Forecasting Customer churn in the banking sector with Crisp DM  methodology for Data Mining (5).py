...
# ## roc_auc_score for KNeighbors Classifier
...
# ## Confusion Matrix for evaluating KNeighbors Classifier
...
# ## Bar plot for performance metrics for KNeighbors Classifier
# 
# 
...
plt.xlabel('Metric')
plt.ylabel('Score')
plt.title('performance metrics for KNeighbors Classifier in Forecasting Customer Churn')
plt.tight_layout()
plt.show()
...
new_churn_data=pd.DataFrame({'Models':['LR','SVC','KNN','DT','RF','GB'],
                             'ROC AUC Score':[roc_auc_score(B_test,B_prob),
              roc_auc_score(B_test,B_prob1),
              roc_auc_score(B_test,B_prob2),
              roc_auc_score(B_test,B_prob3),
              roc_auc_score(B_test,B_prob4),
